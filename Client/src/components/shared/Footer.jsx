            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <a href="https://www.facebook.com/augustyanandan.singh" className="hover:text-gray-400" aria-label="Facebook">
                        ...
                        <a href="https://x.com/AugustyaNandan" className="hover:text-gray-400" aria-label="Twitter">
                        ...
                        <a href="https://www.linkedin.com/in/augustya-nandan-singh-701346334" className="hover:text-gray-400" aria-label="LinkedIn">
